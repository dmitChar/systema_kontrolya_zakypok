        ...
        { 
            ...
            $.ajax({
                ...
                success:function(respose){
                    if(respose == "Ошибка! Введенный поставщик уже поставляет данный материал по данной цене!")
                    {
                        alert("Ошибка! Введенный поставщик уже поставляет данный материал по данной цене!");
                        return;
                    ...
                    alert ("Поставщик успешно доваблен");
...
<body>
  ...
  <li class="nav-item">
  <a class="nav-link active" aria-current="page" href="#">Выбор поставщиков</a>
  </li>
  <li class="nav-item">
